...
/// ChangeNotifier hai. Jab bhi login/district/onboarding complete hoke
/// startupState update hota hai (notifyListeners), GoRouter redirect
/// dobara evaluate karega with FRESH values -- isse "too many redirects"
/// / stuck-on-district-screen wala loop fix ho jaata hai.
GoRouter createRouter(AppStartupState startupState) {
  ...
  return GoRouter(
    ...
    redirect: (context, state) {
      ...
      // 4) Sab set hai -> onboarding/login/district pe wapas mat jaane do
